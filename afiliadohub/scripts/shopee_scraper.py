...
class ShopeeScraper:
            ...
            for item in items:
                try:
                    ...
                    product = {
                        ...
                        / 100000,  # Converter para reais
                        "original_price": item_basic.get("price_before_discount", 0)
                        / 100000,
                        ...
                        "rating_count": item_basic.get("item_rating", {}).get(
                        ...
                        "images": [
                            ...
                            for img in item_basic.get("images", [])
                        ],
                        ...
                        "has_lowest_price_guarantee": item_basic.get(
                    ...
                    product["affiliate_link"] = self._generate_affiliate_link(
                        product["product_id"], product["shop_id"]
                    )
    ...
    async def get_product_details(
        ...
        try:
            ...
            params = {"itemid": product_id, "shopid": shop_id}
