...
class MetricsService(BaseService):
    ...
    async def get_business_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            high_commission = self.product_repo.count(
                filters={"commission_rate__gte": 10.0}
            )
            ...
            return {
                ...
                "products": {
                    ...
                    "by_store": {"shopee": shopee_count, "mercado_livre": ml_count},
    ...
    async def get_top_products(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        """
        try:
            products = self.product_repo.get_by_commission_range(
                min_commission=0, limit=limit
            )

            # Sort by commission
            sorted_products = sorted(
                products, key=lambda p: p.get("commission_rate", 0), reverse=True
            )
