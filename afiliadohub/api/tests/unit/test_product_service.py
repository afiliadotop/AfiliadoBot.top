...
class TestProductService:
    ...
    def test_get_products_no_filters(self, product_service, sample_products_list):
        ...
        # Arrange
        product_service.repository.get_active_products = Mock(
            return_value=sample_products_list
        )
    ...
    def test_get_products_with_store_filter(
        self, product_service, sample_products_list
    ):
    ...
    def test_enrich_product_with_commission(self, product_service):
        ...
        # Arrange
        product = {"current_price": 100.00, "commission_rate": 15.0}
    ...
    def test_validate_invalid_commission_rate(self, product_service):
        ...
        # Act & Assert
        with pytest.raises(
            ValueError, match="Commission rate must be between 0 and 100"
        ):
