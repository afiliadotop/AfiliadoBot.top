...
class LinkProcessor:
    ...
    STORE_PATTERNS = {
        ...
        "temu": [r"temu\.com", r"temu\.to"],
        "shein": [r"shein\.(com|fr|de|es|it|ru|au|ca)", r"shein\.top"],
        "magalu": [r"magazineluiza\.com\.br", r"magalu\.link"],
        "mercado_livre": [
    ...
    def normalize_link(url: str) -> str:
        ...
        try:
            ...
            for key, values in query_params.items():
                key_lower = key.lower()
                is_tracking = any(
                    track in key_lower for track in LinkProcessor.TRACKING_PARAMS
                )
