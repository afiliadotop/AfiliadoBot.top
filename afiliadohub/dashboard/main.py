...
def main():
    ...
    # Página inicial
    st.markdown('<div class="main-header">📊 Dashboard Geral</div>', unsafe_allow_html=True)
    ...
    try:
        ...
        if response.data:
            ...
            if not df.empty:
                ...
                display_df.columns = ['Produto', 'Loja', 'Preço', 'Desconto', 'Adicionado em']
