...
with tab1:
    ...
    with st.form("telegram_config"):
        ...
        with col2:
            save_config = st.form_submit_button("💾 Salvar Configurações", type="primary")
    ...
    with st.form("manual_send"):
        ...
        with col1:
            product_source = st.radio(
                "Fonte do Produto",
                ["Aleatório", "Por Loja", "Por ID", "Por Categoria"]
            )
